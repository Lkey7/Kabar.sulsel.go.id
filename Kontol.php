...
<html lang="en">
  ...
  <head>
    ...
    <meta name="author" content="memek"> 
    ...
    <link href="https://fonts.googleapis.com/css?family=Rock Salt|Righteous" rel="stylesheet">
       ...
       <link rel="icon" href="https://j.top4top.io/p_1792im8d10.png" type="image/jpg">
    ...
    <title><•[+]Uploader Mboh nggone sopo[+]•></title>
...
<style>img[alt="www.000webhost.com"]{display:none;}</style></head>
  ...
  <body>
    ...
    <marquee>	<h2 class="mt-3" color="red" >Ingat Mati</h2> </marquee>

    	<img src="https://i.ibb.co/pLVQ7kq/1607757488366.png" class="mx-auto d-block" id="ico">    	

    	<div id="Clock" align="center" style="font-size:38px;font-family:'iceland';color:white;"></div>

<br><center><audio id="myAudio">

<source src="https://a.top4top.io/m_165463pzo0.mp3" type="audio/ogg" hidden="hidden" >

<source src="https://a.top4top.io/m_165463pzo0.mp3" type="audio/mpeg3" hidden="hidden" >

</audio>

<button onclick="playAudio()" class="bg-transparent text-white" type="button" hidden="hidden" >Play Audio</button>

<button onclick="pauseAudio()" class="bg-transparent text-white" type="button" hidden="hidden" >Pause Audio</button></center>
    	...
    	<form method="post" enctype="multipart/form-data">
    		...
    		<div class="row">
    			...
    			<div class="col">
    				...
    				<input id="previews" placeholder="Pilih Jodoh" class="form-control bg-transparent text-white" readonly="readonly">
    		...
    		<button type="submit" name="upload" class="btn btn-secondary btn-block bg-transparent mt-3" id="load" data-loading-text="<i class='fa fa-refresh fa-spin'></i> Silahkan tunggu">pencet aing</button>
